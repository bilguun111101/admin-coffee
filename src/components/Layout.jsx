import { useDashboard, useLayout } from "../context";
...
export const Layout = ({ children }) => {
    const { remove } = useLayout();
  return (
    <section className='w-full h-screen flex dark:bg-slate-900'>
        {/* navbar */}
        <div className={`w-1/6 relative h-full p-8 overflow-hidden backdrop-blur ${remove && "hidden"}`}>
